  ...
  const services = {
    ...
    "speaking": {
      ...
      content: `
        ...
        <p>Audiences consistently highlight three aspects of Krishna Kumar's presentations:</p>
        <ul>
